...
book_data = pd.read_csv("F:/assignment/association rules -unsupervised learning/Datasets_Association Rules/book.csv")
book_data.info
book_data.columns
book_data.count
book_data.describe
...
with open("F:/assignment/association rules -unsupervised learning/Datasets_Association Rules/groceries.csv") as f:
    groceries = f.read()
...
movies_data = pd.read_csv("F:/assignment/association rules -unsupervised learning/Datasets_Association Rules/my_movies.csv")
movies_data.columns
...
phone_data = pd.read_csv("F:/assignment/association rules -unsupervised learning/Datasets_Association Rules/myphonedata.csv")
phone_data.columns
phone_data.isna().sum()
...
transaction_data = []
with open("F:/assignment/association rules -unsupervised learning/association rules -unsupervised learning/transactions_retail1.csv") as f:
...
X = transacation_series["retails"].str.join(sep = '*').str.get_dummies(sep = '*')
X = X.drop(['NA'] , axis =1)
